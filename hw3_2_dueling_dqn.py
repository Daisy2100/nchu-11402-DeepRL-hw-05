...
class DuelingDQN(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        val = torch.nn.functional.relu(self.val_fc(x))
        val = self.val_out(val)
        
        adv = torch.nn.functional.relu(self.adv_fc(x))
...
def run_hw3_2_dueling():
    ...
    print("HW3-2 (Dueling DQN on player mode) Finished Training!")
